...
export const initialProducts = [
  {
    ...
    longDescription: (
      <>
        <strong>L’Erbe Riflessanti - Nutri</strong> è una miscela di erbe pensata per{" "}
        <strong>nutrire</strong> e <strong>rinforzare</strong> la fibra capillare, migliorando struttura e luminosità. È{" "}
        <strong>incolore</strong>, ideale per chi cerca un trattamento rigenerante senza alterare il colore.
        <h5 className="mt-3">Modo d'uso:</h5>
        <ul>
          <li>
            Applicare su tutta la capigliatura e lasciare in posa <strong>20 minuti</strong>.
          </li>
          <li>Risciacquare e procedere con uno shampoo leggero.</li>
          <li>
            Su capelli bianchi o biondi, miscelare con <strong>Henné Rosso</strong> per maggiore copertura.
          </li>
        </ul>
        <h5 className="mt-3">Benefici:</h5>
        <ul>
  ...
  },
  {
    ...
    longDescription: (
      <>
        <strong>L’Erbe Riflessanti - Rosso</strong> è un henné puro a base di{" "}
        <strong>Lawsonia inermis</strong>, perfetto per ottenere un <strong>rosso intenso</strong> con benefici rinforzanti.
        <h5 className="mt-3">Modo d'uso:</h5>
        <ul>
          <li>
            Mescolare con <strong>acqua calda</strong> fino a ottenere una crema liscia.
          </li>
  ...
  },
  {
    ...
    longDescription: (
      <>
        <strong>L’Erbe Riflessanti - Mallo di Noce</strong> è ideale per ottenere{" "}
        <strong>riflessi castani</strong> naturali e attenuare i toni caldi indesiderati.
        <h5 className="mt-3">Modo d'uso:</h5>
        <ul>
          <li>
            Mescolare la polvere con <strong>acqua molto calda</strong> fino a ottenere un impasto cremoso.
          </li>
  ...
  },
  {
    ...
    longDescription: (
      <>
        <strong>L’Erbe Riflessanti - Rosso Profondo</strong> è una miscela arricchita per ottenere un{" "}
        <strong>rosso freddo e vibrante</strong>, ideale per tonalità più sature.
        <h5 className="mt-3">Modo d'uso:</h5>
        <ul>
          <li>
            Mescolare con <strong>acqua calda</strong> e applicare sui capelli.
          </li>
          <li>
            Più la base è chiara, più il risultato sarà <strong>brillante</strong>.
          </li>
        </ul>
        <h5 className="mt-3">Benefici:</h5>
        <ul>
    ...
    <>
      ...
      <Container className="products-container mt-5 pt-5">
        ...
        <p className="text-center text-muted mb-4">
          Scopri la nostra selezione di <strong>erbe riflessanti</strong> naturali per capelli più sani e luminosi.
        </p>
        ...
        <div className="text-center mt-5">
          ...
          <p className="text-muted">
            Tutti i nostri prodotti sono <strong>100% naturali</strong>, senza agenti chimici nocivi.
          </p>
        </div>
      </Container>
    </>
